...
function Switch({
    ...
    return (
        <button
            ...
            disabled={disabled}
            onClick={onChange}
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${checked ? "bg-[#3d2e7c]" : "bg-gray-300"
                }`}
        >
            <span
    ...
    const color =
        label === "Weak"
            ...
            : label === "Medium"
                ...
                : "bg-green-500";
    const width =
        label === "Weak" ? "33%" : label === "Medium" ? "66%" : "100%";
    ...
    return (
        <div className="mt-2">
            <div className="flex items-center justify-between mb-1">
                ...
                <span
                    className={`text-xs font-semibold ${label === "Weak"
                        ? "text-red-500"
                        : label === "Medium"
                            ? "text-yellow-600"
                            : "text-green-600"
            ...
            <div className="max-w-[1000px] mx-auto px-8 py-12">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        {banner && (
                            <div
                                className={`rounded-lg px-4 py-3 text-sm font-medium ${banner.kind === "success"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full pr-10 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${pwErrors.currentPassword ? "border-red-500" : "border-gray-300"
                                                }`}
                                        />
                                        <button
                                            type="button"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full pr-10 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${pwErrors.newPassword ? "border-red-500" : "border-gray-300"
                                                }`}
                                        />
                                        <button
                                            type="button"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full pr-10 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${pwErrors.confirmNewPassword ? "border-red-500" : "border-gray-300"
                                                }`}
                                        />
                                        <button
                                            type="button"
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${deactivateErrors.password ? "border-red-500" : "border-gray-300"
                                }`}
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                setDeactivateData((prev) => ({ ...prev, reason: e.target.value }))
                            }
            ...
            <Modal open={showDeleteModal} onClose={closeDeleteModal}>
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter your password"
                            className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${deleteErrors.password ? "border-red-500" : "border-gray-300"
                                }`}
                        />
                    ...
                    <div>
                        ...
                        >
                            Type{" "}
                            <span className="font-bold text-red-600">{DELETE_CONFIRMATION_PHRASE}</span> to
                            confirm
                        </label>
                        <input
                            ...
                            className={`w-full font-mono px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3d2e7c]/30 ${deleteErrors.confirmation ? "border-red-500" : "border-gray-300"
                                }`}
                        />
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    <button
                        ...
                        disabled={
                            isDeleting || deleteData.confirmation !== DELETE_CONFIRMATION_PHRASE
                        }
